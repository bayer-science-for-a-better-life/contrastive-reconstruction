...
def preprocess_for_train(image,
  ...
  if color_distort:
    image = random_color_jitter(image, impl=impl, color_jitter_strength=color_jitter_strength)
...
def preprocess_image(image, height, width, is_training=False,
                     color_distort=True, test_crop=True, color_jitter_strength=0.5):
  ...
  if is_training:
    return preprocess_for_train(image, height, width, color_distort, color_jitter_strength=color_jitter_strength)
  else:
